...
def get_ladder_network_fc(layer_sizes=[768, 1000, 500, 250, 250, 250, 10], 
     noise_std=0.3,
    ...
    tr_m.compile(keras.optimizers.Adam(lr=0.02 ), 'categorical_crossentropy', metrics=METRICS) #metrics=['accuracy']
